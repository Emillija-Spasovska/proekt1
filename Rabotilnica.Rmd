...
ggplot(traffacc, aes(
  ...
  geom_point(size = 3, aplha = 0.9, pch = 21) +
  labs(fill = "Вид на повреда") +
  scale_color_viridis(discrete = TRUE, option = "D") +
  facet_wrap("TypeOfRoadMK", ncol = 3) +
  theme(legend.position = "top") +
  scale_y_time() +
  labs(title = "Сообраќајни незгоди по години на велосипедист и час во денот", x = "Возраст на велосипедист", y = "Час од денот во кој е склучена незгода") +
  ggsave("plot.png")
